...
import { ArrowLeft, UtensilsCrossed, IndianRupee, Tag, Info } from "lucide-react";
...
const AddFoodItem = () => {
  ...
  const handleSubmit = async (e) => {
    setLoading(true);
    e.preventDefault();
    if (!myShopData?._id) return toast.error("Shop information missing!");
    ...
    data.append("shop", myShopData._id); // Linking the item to the current shop
    ...
    <div className="flex justify-center flex-col items-center p-6 bg-linear-to-br from-orange-50 to-white min-h-screen relative">
      ...
      <div className="max-w-md w-full bg-white shadow-2xl rounded-3xl p-8 border border-orange-100 my-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-black text-gray-800 uppercase tracking-tight">Edit Item</h2>
          <p className="text-gray-400 text-sm">Fill in the details for your new dish</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="w-full h-40 mb-3 relative rounded-2xl border-2 border-dashed border-orange-200 overflow-hidden bg-orange-50 flex items-center justify-center">
              {imagePreview ? (
                ...
                <div className="text-center">
                  <p className="text-orange-400 text-xs font-medium">Click below to upload image</p>
                </div>
              )}
            </div>
            <input 
          ...
          <div>
            ...
            <input 
              type="text" name="name" placeholder="e.g. Paneer Butter Masala" required
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  type="number" name="price" placeholder="0.00" required
                  value={formData.price} onChange={onChangeHandler}
            ...
            <div className="flex gap-4">
              {["veg", "non veg"].map((type) => (
                <label key={type} className="flex-1">
                  <input 
                    type="radio" name="foodtype" value={type}
                  ...
                  <div className={`text-center py-2 rounded-xl border-2 cursor-pointer transition-all capitalize text-sm font-bold
                    ${type === 'veg' ? 'peer-checked:border-green-500 peer-checked:bg-green-50 text-green-600' : 'peer-checked:border-red-500 peer-checked:bg-red-50 text-red-600'}
